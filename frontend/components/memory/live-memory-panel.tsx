...
const OP_STYLES: Record<string, string> = {
  ...
  improve:
    "bg-[#E8EEFC] text-[#2452B7] border border-[#C9D8F8]",
...
export function LiveMemoryPanel() {
  ...
  return (
    <div className="flex h-full min-h-[620px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      {/* Header */}
      <div className="flex items-center gap-4 border-b border-slate-200 px-6 py-5">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            Real-time Cognee lifecycle events
          </p>
        </div>
      ...
      {(stats.nodes > 0 || stats.edges > 0) && (
        <div className="flex items-center gap-6 border-b border-slate-200 bg-slate-50 px-5 py-3 text-sm text-slate-600">
          <div className="flex items-center gap-2">
            <Network className="h-4 w-4 text-[#2452B7]" />
            <span>
